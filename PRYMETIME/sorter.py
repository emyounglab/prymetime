...
######################################################
fasta_sequences = SeqIO.parse(open("scaffolds.fasta"),'fasta')

cir_seqs = [x for x in fasta_sequences if circ_D[x.id] is "+"]
...
lin_seqs = [x for x in fasta_sequences if circ_D[x.id] is '-']
